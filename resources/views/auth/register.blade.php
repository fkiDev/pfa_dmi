    ...
    <div class="widget-content col-md-8 col-md-offset-2">
        <div class="tabbable" >
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="etudiant">
                        <div class="row">
                            <h3 class="text-center">Etudiant:</h3>
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('etudiant/register') }}">
                                {!! csrf_field() !!}
                ...
                <div class="tab-pane fade" id="proffesseur">
                    <div class="row">
                        <h3 class="text-center">Professeur:</h3>

                        <form class="form-horizontal" role="form" method="POST" action="{{ url('professeur/register') }}">
                            {!! csrf_field() !!}
